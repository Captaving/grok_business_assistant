...
async def show_instructions(callback: CallbackQuery):
    text = (
        ...
        "1. Убедись, что у тебя включён **Telegram Premium** (или Business уже доступен).\n\n"
        "2. Зайди в **Настройки → Telegram для бизнеса**.\n\n"
        "3. Пролистай вниз и найди раздел **«Чат-боты»**.\n\n"
        "4. Нажми **«Добавить бота»** и введи юзернейм этого бота.\n\n"
